...
lambda_description = 'Lambda function that can be scheduled to clean up Old AMIs'
...
# Who is the author?
lambda_author = 'Vinay Kumar'
lambda_author_email = 'vchinnakotla@quinovas.com'
